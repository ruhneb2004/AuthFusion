...
export default function Home() {
  ...
  return (
    <div className="">
      ...
      <div className={`${anonymousPro.className} flex justify-center items-center h-screen w-full`}>
        <div className="w-9/12 lg:w-8/12 xl:w-6/12 max-w-[700px] bg-red-200 shadow-[0px_-12px_10px_rgba(0,0,0,0.2)] z-10 py-12 md:py-24 rounded-[15%] flex flex-col gap-10 sm:gap-20 justify-center items-center">
          {/* for current email! */}
          <div className="bg-red-300 w-9/12 text-center py-7  rounded-full shadow-inner shadow-gray-500 text-xl md:text-2xl relative">
          ...
          <div className="bg-red-300 w-9/12 text-center py-7 rounded-full shadow-inner shadow-gray-500 text-xl md:text-2xl relative">
            <div className="px-16 truncate">{convertAddress(account.address || "")}</div>
            <div
          ...
          <button
            className={`btn bg-blue-200 border-none ${sig ? "hidden" : ""} sm:text-lg text-md md:text-xl h-16 px-10`}
